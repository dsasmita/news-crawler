...
Revision ID: c75da83dc085
Revises: 
Create Date: 2018-06-11 13:36:07.057715
...
def upgrade():
    ...
    sa.Column('title_sub', sa.Text(), nullable=True),
    ...
    sa.Column('link_index', sa.String(length=255), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )

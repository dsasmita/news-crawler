...
# Tempo
@module_crawler_news.route('/tempo/category-insert')
def tempo_category_insert():
    ...
    tempo = TempoCrawler()
    tempo.id_news = portal.id
    tempo.link_index = portal.link_index
    kanals = tempo.get_kanal()
